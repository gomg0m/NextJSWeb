...
export default function handler(req, res) {
  ...
  if(req.method == 'POST') {
    ...
    const user_query = 'INSERT INTO PRODUCTINFO'
    + ' (product_hope, product_discussname, product_firstimage, product_lasttime)'
    + ' VALUES (?, ?, ?, ?)';
    ...
    let params = [hope, discussname, firstimage, lasttime];
