...
export default function handler(req, res) {
  ...
  if(req.method == 'POST') {
    ...
    let user_query = 'INSERT INTO POSTCOMMENT'+ req.body.data.tableid 
    + ' (postcomment_name, postcomment_team, postcomment_contents, postcomment_lasttime, postcomment_image)'
    + ' VALUES (?, ?, ?, ?, ?)';
