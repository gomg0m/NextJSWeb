...
export default function handler(req, res) {
  ...
  if(req.method == 'POST') {
    ...
    let user_query = 'INSERT INTO PRODUCTCOMMENT'+ req.body.data.tableid 
    + ' (prdtcomment_name, prdtcomment_team, prdtcomment_contents, prdtcomment_lasttime, prdtcomment_image)'
    + ' VALUES (?, ?, ?, ?, ?)';
