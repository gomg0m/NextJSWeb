...
/////=========== modal 메인 페이지 ================================
export default function NewProductProject(props){ 
  ...
  return(
        ...
        >
          <Box sx={style}>
            ...
            <Typography className={styles.addshowtitle}>제작관련 협의</Typography>
            <Typography className={styles.addshowsubtitle}>제작관련 협의를 추가해주세요.</Typography>
            <Divider className={styles.modaldivider} orientation="horizontal" variant="fullWidth" flexItem />            
            <div className={sty.body_row1}>
                <div className={sty.body_row_subitem1}>관련 희망연출명</div>
            ...
            <div className={sty.body_row2}>
                <div className={sty.body_row_subitem1}>제작협의명</div>                     
                <div className={sty.body_row_subitem2} style={{width:"500px", margin:"-15px 30px 0px"}} ><FormInputText name="prj_discussname" control={control} label="기술구체화협의명을 입력해주세요." /></div>
            </div>
