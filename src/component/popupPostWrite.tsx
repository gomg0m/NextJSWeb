  ...
  return(
        ...
        >
          <Box sx={style}>
            ...
            <Typography className={styles.addshowtitle}>후속처리 협의</Typography>
            <Typography className={styles.addshowsubtitle}>후속처리 협의를 추가해주세요.</Typography>
            ...
            <div className={sty.body_row2}>
                <div className={sty.body_row_subitem1}>후속처리 협의명</div>                     
